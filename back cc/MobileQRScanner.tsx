...
export const MobileQRScanner: React.FC<MobileQRScannerProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background-dark p-6">
      ...
      <button
        onClick={startScan}
        className="w-full max-w-md px-8 py-4 bg-primary text-black rounded-xl font-bold text-lg hover:bg-primary/90 transition-all active:scale-95 shadow-lg shadow-primary/20 mb-4"
      >
        Démarrer le Scanner
      </button>
      ...
      {showManualEntry && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-6">
          <div className="w-full max-w-md bg-card-dark rounded-2xl p-6 border border-white/10">
            <h3 className="text-xl font-bold mb-4">Saisie Manuelle</h3>
            <input
              type="text"
              value={manualCode}
